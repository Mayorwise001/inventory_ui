    ...
    <div className="gsk-hero-content">
      ...
      <p className="gsk-hero-desc">
        ...
        <strong>Reduce costs, eliminate stockouts, and scale your business</strong>—all in one intuitive platform.
            ...
            <a href="/learn-more" className="gsk-hero-cta" aria-label="Learn more about inventory management">
        Get Started
        <svg width="22" height="22" fill="none" viewBox="0 0 24 24" className="cta-arrow" aria-hidden="true">
